...
Collapsable.defaultProps = { children: 'Some collapsable stuff' }

/**
 * @uikit Ellipsis
 * @import Ellipsis
 *
 * @description Ellipsis-trimmed text
 * @category Helpers
 */
...
Ellipsis.defaultProps = { children: 'Some long text bla bla bla', maxWidth: '100px'}